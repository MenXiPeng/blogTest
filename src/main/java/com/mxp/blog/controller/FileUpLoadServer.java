...
public class FileUpLoadServer {
    ...
    public  void upload(HttpServletRequest request, PrintWriter writer,
        ...
        this.SaveAs("E:\\upload\\" + file.getOriginalFilename(), file, request
        );
        // 设置返回值
        List list = new ArrayList();
        Map<String, Object> map = new HashMap<>();
//        map.put("errno", 0);
        list.add("D:\\" + file.getOriginalFilename());
        map.put("url", "http://localhost:8080/image/" + file.getOriginalFilename());
